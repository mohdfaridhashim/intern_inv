        ...
        <div class="container">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div id="inventoryTable_wrapper" class="dataTables_wrapper no-footer">
                        <div class="dataTables_length" id="inventoryTable_length">
                            <label> Show 
                                <select name="inventoryTable_length" aria-controls="inventoryTable" class="">
                        ...
                        <div id="inventoryTable_filter" class="dataTables_filter">
                            <label> Search: 
                                <input type="search" class="" placeholder="" aria-controls="inventoryTable">
                            </label>
                        </div>

                        <table class="table table-hover table-striped table-bordered dataTable no-footer" id="inventoryTable" role="grid" aria-describedby="inventoryTable_info" style="width: 1108px;">
                        <thead>
                            <tr role="row">
                                <th style="width:25%;"> Inventory </th>
                                <th class="sorting" tabindex="0" aria-controls="inventoryTable" rowspan="1" colspan="1" aria-label="Name: activate to sort column ascending"> Name </th>
                                <th class="sorting" tabindex="0" aria-controls="inventoryTable" rowspan="1" colspan="1" aria-label="Quantity: activate to sort column ascending" style="width:20%;"> Quantity </th>
                            </tr>
                        </thead>
