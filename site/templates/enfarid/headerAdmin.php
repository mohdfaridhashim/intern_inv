        ...
        <nav class="navbar navbar-default navbar-static-top">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">      
                ...
                <ul class="nav navbar-nav navbar-right">        
                    ...
                    <li id="navInventory"><a href="adminInventory.php"><i class="glyphicon glyphicon-inbox"></i> Inventory </a></li>        
                    <li id="navApplication"><a href="adminStatus.php"> <i class="glyphicon glyphicon-plus"></i> View Status </a></li>        
                    <li id="navUpdate"><a href="adminUpdate.php"><i class="glyphicon glyphicon-pencil"></i> Update Inventory </a></li>
                    ...
                    <li class="dropdown" id="navSettings">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> <i class="glyphicon glyphicon-cog"></i> <span class="caret"></span></a>
                            <ul class="dropdown-menu">    
                                ...
                                <li id="topNavUser"><a href="adminUser.php"><i class="glyphicon glyphicon-th-list"></i> Admin </a></li>                               
