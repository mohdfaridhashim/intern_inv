var manageApplyTable;

$(document).ready(function(){
    $('#navApplication').addClass('active');

    manageApplyTable = $('#manageApplyTable').DataTable({
        'ajax'  : 'phpaction/fetchApplication.php',
        'apply' : []
    });

    $('#addInventoryModalBtn').unbind('click')
})
/*$(document).ready(function() {
