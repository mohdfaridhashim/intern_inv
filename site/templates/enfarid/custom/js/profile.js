			...
			$.ajax({
				...
				success:function(response) {
					...
					if(response.success == true)  {												
						...
						$('.changeAdminUsernameMessages').html('<div class="alert alert-success">'+
	          ...
	          $(".alert-success").delay(500).show(10, function() {
						...
						// shows a successful message after operation
						$('.changeAdminUsernameMessages').html('<div class="alert alert-warning">'+
	            '<button type="button" class="close" data-dismiss="alert">&times;</button>'+
		...
		if(currentPassword == "" || newPassword == "" || conformPassword == "") {
			...
			$.ajax({
				...
				success:function(response) {
					...
					if(response.success == true) {
						$('.changeAdminPasswordMessages').html('<div class="alert alert-success">'+
	            '<button type="button" class="close" data-dismiss="alert">&times;</button>'+
	            '<strong><i class="glyphicon glyphicon-ok-sign"></i></strong> '+ response.messages +
	          '</div>');
	          ...
	          $(".alert-success").delay(500).show(10, function() {
						...
						$('.changeAdminPasswordMessages').html('<div class="alert alert-warning">'+
	            '<button type="button" class="close" data-dismiss="alert">&times;</button>'+
	            '<strong><i class="glyphicon glyphicon-exclamation-sign"></i></strong> '+ response.messages +
	          '</div>');
