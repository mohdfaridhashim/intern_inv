...
<html>
    <head>
        <meta name="viewport" content="width=device-width, initial-scale=1">
            ...
            <!-- bootstrap -->
            <link rel="stylesheet" href="enfarid/assests/bootstrap/css/bootstrap.min.css">
            <!-- bootstrap theme-->
            <link rel="stylesheet" href="enfarid/assests/bootstrap/css/bootstrap-theme.min.css">
            <!-- font awesome -->
            <link rel="stylesheet" href="enfarid/assests/font-awesome/css/font-awesome.min.css">

            <!-- custom css -->
            <link rel="stylesheet" href="enfarid/custom/css/custom.css">

            <!-- DataTables -->
            <link rel="stylesheet" href="enfarid/assests/plugins/datatables/jquery.dataTables.min.css">

            <!-- file input -->
            <link rel="stylesheet" href="enfarid/assests/plugins/fileinput/css/fileinput.min.css">

            <!-- jquery -->
                <script src="enfarid/assests/jquery/jquery.min.js"></script>
            <!-- jquery ui -->  
            <link rel="stylesheet" href="enfarid/assests/jquery-ui/jquery-ui.min.css">
            <script src="enfarid/assests/jquery-ui/jquery-ui.min.js"></script>

            <!-- bootstrap js -->
            <script src="enfarid/assests/bootstrap/js/bootstrap.min.js"></script>
    </head>
